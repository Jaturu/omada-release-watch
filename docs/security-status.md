...
No High or Critical findings. 18 lower-severity finding(s) recorded below.
...
|---|---|---|---|
| CVE-2025-15366 | Medium | python 3.13.14 | 3.15.0a6 |
...
| CVE-2026-0864 | Medium | python 3.13.14 | 3.15.0b4 |
| CVE-2026-12003 | Medium | python 3.13.14 | 3.15.0b3 |
| CVE-2026-4360 | Medium | python 3.13.14 | No fix available |
| CVE-2026-6879 | Low | python 3.13.14 | No fix available |
...
|---|---|---|---|---|
| CVE-2026-11940 | High | python 3.13.14 | 3.15.0b4 | tarfile is never imported, so unreachable. Tracked in #5, retired by #7 |
| CVE-2026-11972 | High | python 3.13.14 | 3.15.0b4 | tarfile is never imported, so unreachable. Tracked in #5, retired by #7 |
